-- ====================================================================
-- SKILLSCATALYST - COMPLETE UNIFIED PRODUCTION SUPABASE SQL SCHEMA
-- ====================================================================
-- Production-ready PostgreSQL / Supabase Schema for SkillsCatalyst
-- Covers: User Profiles, Coding Stats, Progress Tracking, Saved Playlists,
-- Video Progress, Resume Scores, Aptitude Categories, Topics, Questions,
-- Timer Options, Analytics Views, Trigger & RLS Security Hardening.
--
...
-- ====================================================================
-- PLACEMENT & QUANTITATIVE APTITUDE PREP SCHEMA & SEED DATA
-- ====================================================================
