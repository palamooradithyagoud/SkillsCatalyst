...
export default function StudentQuizPage() {
  ...
  // ── Common header ──────────────────────────────────────────────────────────
  const Header = () => (
    <header className="sticky top-0 z-20 h-14 border-b border-slate-200/90 bg-white/90 backdrop-blur-md px-4 sm:px-8 flex items-center justify-between shadow-xs">
      <Link
      ...
      <div className="flex items-center gap-2 text-xs font-semibold text-purple-700 px-2.5 py-1 rounded-full bg-purple-50 border border-purple-200/80">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-4 px-4">
          ...
          {viewState === "loading" && (
            <div className="w-full max-w-lg space-y-3 mt-4 animate-pulse">
              ...
              <div className="h-20 bg-white border border-slate-200/90 rounded-2xl shadow-xs" />
              <div className="h-12 bg-white border border-slate-200/90 rounded-xl shadow-xs" />
              <div className="h-12 bg-white border border-slate-200/90 rounded-xl shadow-xs" />
              <div className="h-12 bg-white border border-slate-200/90 rounded-xl shadow-xs" />
            </div>
          )}
    ...
    return (
      <div className="min-h-screen bg-[#F8FAFC] text-slate-900 flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 py-16 text-center max-w-sm mx-auto">
          ...
          <h1 className="text-xl font-bold text-slate-900 mb-2">Quiz Unavailable</h1>
          ...
          <div className="flex gap-3 flex-wrap justify-center">
            <Link
              href={`/courses/${courseIdOrSlug}`}
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white hover:bg-slate-50 text-slate-700 font-medium text-sm transition-all border border-slate-200/90 shadow-xs"
              id="quiz-error-back"
            >
              <ArrowLeft className="w-4 h-4" />
              Back to Course
  ...
  if (viewState === "locked") {
    return (
      <div className="min-h-screen bg-[#F8FAFC] text-slate-900 flex flex-col">
        <Header />
        <div className="flex-1 flex flex-col items-center justify-center px-4 py-16 text-center max-w-sm mx-auto">
          <div className="p-5 rounded-2xl bg-amber-50 border border-amber-200 text-amber-600 mb-5">
            <Lock className="w-10 h-10" />
          </div>
          <h1 className="text-xl font-bold text-slate-900 mb-2">Quiz Locked</h1>
          <p className="text-sm text-slate-600 mb-6 leading-relaxed">
            Complete all lessons in this module before taking the quiz.
          </p>
          <Link
            href={`/courses/${courseIdOrSlug}`}
            className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-purple-600 hover:bg-purple-700 text-white font-semibold text-sm shadow-sm transition-all"
            id="quiz-locked-back"
          >
      ...
      <div className="min-h-screen bg-[#F8FAFC] text-slate-900 flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 py-8">
          <div className="w-full max-w-lg space-y-6">
            ...
            <div
              id="quiz-result-card"
              className={`rounded-3xl border p-8 text-center shadow-xs bg-white ${
                passed
                  ? "border-emerald-300"
                  : "border-rose-300"
              }`}
            >
              ...
              {/* Verdict */}
              <h1 className={`text-3xl font-black mb-1 ${passed ? "text-emerald-700" : "text-rose-700"}`}
              ...
              <div className="flex items-center justify-center gap-6 mb-6">
                <div className="text-center">
                  <div className={`text-5xl font-black mb-1 ${passed ? "text-emerald-600" : "text-rose-600"}`}
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-slate-700" id="quiz-result-passing-score">
              ...
              {/* Correct count */}
              <div className="text-sm text-slate-600 mb-4" id="quiz-result-counts">
              ...
              <div className="w-full h-3 bg-slate-100 rounded-full overflow-hidden mb-6">
                <div
                  className={`h-full rounded-full transition-all duration-700 ${
                    passed ? "bg-emerald-600" : "bg-rose-500"
                  }`}
              ...
              <div className="relative h-1 bg-transparent -mt-5 mb-5">
                <div
                  className="absolute top-0 w-0.5 h-4 bg-amber-500 rounded"
              ...
              {moduleComplete && (
                <div className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-700 font-bold text-sm mb-4"
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          ...
                          <p className={`text-[11px] mt-0.5 font-semibold ${ar.is_correct ? "text-emerald-700" : "text-rose-700"}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              {!passed && (
                <button
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-purple-600 hover:bg-purple-700 text-white font-bold text-sm shadow-sm transition-all"
                >
              ...
              <Link
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-white hover:bg-slate-50 text-slate-700 font-semibold text-sm border border-slate-200/90 shadow-xs transition-all"
              >
                <ArrowLeft className="w-4 h-4" />
    ...
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center px-4 py-6 sm:py-10">
        <div className="w-full max-w-2xl space-y-6">
          ...
          {/* Quiz Title */}
          <div className="text-center">
            <h1 className="text-xl sm:text-2xl font-black text-slate-900" id="quiz-title">
              {quiz.title}
            </h1>
            {quiz.description && (
            ...
            <div className="flex items-center justify-center gap-4 mt-3 text-xs text-slate-500 font-medium">
              <span>Passing score: <span className="text-slate-800 font-bold">{quiz.passing_score}%</span></span>
              <span>•</span>
            ...
            {quiz.questions.map((q, idx) => (
              <button
                ...
                className={`w-7 h-7 rounded-lg text-[11px] font-bold transition-all ${
                  idx === currentIndex
                    ? "bg-purple-600 text-white scale-110 shadow-xs ring-2 ring-purple-600/30"
                    : answers[q.id]
          ...
          <div className="rounded-2xl border border-slate-200/90 bg-white p-6 sm:p-8 shadow-xs">
            ...
            <div className="flex items-center justify-between mb-5">
              <span className="text-xs font-bold uppercase tracking-wider text-purple-700 bg-purple-50 px-2.5 py-1 rounded-md border border-purple-200/80"
                  ...
                  return (
                    <label
                      ...
                      className={`flex items-center gap-4 p-4 rounded-xl border cursor-pointer transition-all ${
                        isSelected
                          ? "bg-purple-50 border-purple-600 shadow-xs ring-1 ring-purple-600/20"
          ...
          <div className="flex items-center justify-between gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white hover:bg-slate-50 text-slate-700 font-semibold text-sm border border-slate-200/90 shadow-xs transition-all disabled:opacity-40 disabled:cursor-not-allowed"
            >
            ...
            {isLastQuestion ? (
              <button
                ...
                className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-sm shadow-xs transition-all ${
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-purple-600 hover:bg-purple-700 text-white font-semibold text-sm shadow-xs transition-all"
              >
...
function AttemptHistoryPanel({ history }: { history: QuizAttemptHistory }) {
  ...
  return (
    <div className="rounded-2xl border border-slate-200/90 bg-white p-5 shadow-xs" id="quiz-attempt-history">
        ...
        {[...history.attempts].reverse().map((attempt) => (
          ...
          >
            ...
            <div className="text-right">
              <span className={`text-sm font-bold ${attempt.passed ? "text-emerald-700" : "text-slate-800"}`}>
                {attempt.score_percentage}%
              </span>
              <p className={`text-[11px] font-semibold ${attempt.passed ? "text-emerald-700" : "text-rose-600"}`}>
