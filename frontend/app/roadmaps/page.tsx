...
const CAREER_ROADMAPS: PresetRoadmap[] = [
  ...
  },
  {
    ...
    sections: [
      {
        title: "Operating Systems, Programming & Scripting",
        subtitle: "Linux distributions, terminal utilities, shell scripting, programming languages, and version control.",
        nodes: [
          "Programming Languages (Python, Go, Node.js)",
          "Operating Systems (Linux Ubuntu/Debian, RHEL, Windows)",
          "Terminal Knowledge & Utilities (Process/Performance Monitoring)",
          "Shell Scripting (Bash & PowerShell)",
          "Version Control & Hosting (Git, GitHub, GitLab)",
        ],
      },
      {
        title: "Networking, Web Servers & Cloud Runtimes",
        subtitle: "Networking protocols, reverse proxies, web servers, cloud providers, and serverless compute.",
        nodes: [
          "Networking & Protocols (HTTP/S, SSH, SSL/TLS, DNS, OSI)",
          "Web Servers & Reverse Proxies (Nginx, Apache, Caddy, Load Balancers)",
          "Containers (Docker & LXC)",
          "Cloud Providers (AWS, GCP, Azure, DigitalOcean)",
          "Serverless Compute (AWS Lambda, Cloudflare Workers, Vercel)",
        ],
      },
      {
        title: "Infrastructure Provisioning & Configuration",
        subtitle: "Infrastructure as Code (IaC), configuration management, and secret storage.",
        nodes: [
          "Infrastructure Provisioning (Terraform, AWS CDK, Pulumi)",
          "Configuration Management (Ansible, Chef, Puppet)",
          "Secret Management (HashiCorp Vault, Sealed Secrets)",
        ],
      },
      {
        title: "CI/CD Pipelines & Artifact Management",
        subtitle: "Continuous integration, deployment tools, and artifact registries.",
        nodes: [
          "CI/CD Automation (GitHub Actions, GitLab CI, Jenkins, CircleCI)",
          "Artifact Management (JFrog Artifactory, Sonatype Nexus)",
          "GitOps Workflows (ArgoCD & FluxCD)",
        ],
      },
      {
        title: "Monitoring, Observability & Container Orchestration",
        subtitle: "Metrics monitoring, log aggregation, distributed tracing, Kubernetes, and service mesh.",
        nodes: [
          "Container Orchestration (Kubernetes, EKS/GKE/AKS, Helm)",
          "Infrastructure Monitoring (Prometheus & Grafana)",
          "Log Management (Elastic Stack ELK, Loki, Splunk)",
          "Observability & Distributed Tracing (OpenTelemetry, Jaeger)",
          "Service Mesh (Istio, Consul, Envoy)",
