...
export default function PricingModal({ isOpen, onClose }: PricingModalProps) {
  ...
  const handleSelectPlan = (plan: "free" | "1month" | "3months", planName: string, price: string) => {
    setSelectedPlan(plan);
    if (plan === "free") {
      setToastMessage("You are currently on the Free plan.");
    } else {
      setToastMessage(`Selected ${planName} (${price}) — Payment gateway integration ready!`);
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 items-stretch">
              ...
              <div className="retro-pricing-card border-white/40 shadow-[0.4rem_0.4rem_#666666]">
                ...
                <div className="mt-5 pt-3 border-t border-white/15">
                  <button
                    type="button"
                    onClick={() => handleSelectPlan("free", "Free Plan", "₹0")}
              ...
              <div className="retro-pricing-card border-white shadow-[0.4rem_0.4rem_#ffffff] relative">
                ...
                <div className="mt-5 pt-3 border-t border-white/20">
                  <button
                    type="button"
                    onClick={() => handleSelectPlan("1month", "1 Month Plan", "₹99")}
                    className="w-full py-2.5 rounded-xl bg-white text-black font-extrabold text-xs hover:bg-slate-200 transition-all shadow-md active:scale-95 cursor-pointer"
                  >
                    Get 1 Month Pass (₹99)
                  </button>
                </div>
              ...
              <div className="retro-pricing-card border-emerald-400 shadow-[0.45rem_0.45rem_#10b981] relative bg-gradient-to-b from-[#0f241a] to-black">
                ...
                <div className="mt-5 pt-3 border-t border-emerald-400/30">
                  <button
                    type="button"
                    onClick={() => handleSelectPlan("3months", "3 Months Plan", "₹250")}
                    className="w-full py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 text-black font-black text-xs hover:from-emerald-400 hover:to-teal-400 transition-all shadow-md active:scale-95 cursor-pointer"
                  >
                    Get 3 Months Pass (₹250)
                  </button>
                </div>
              </div>
            </div>
